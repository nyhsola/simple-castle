...
class PhysicSystem(private val camera: Camera) : IteratingSystemAdapter(Family.all(PositionComponent::class.java, PhysicComponent::class.java).get()), EntityListener {
    ...
    override fun entityAdded(entity: Entity) {
        ...
        dynamicsWorld.addRigidBody(physicComponent.physicObject.body, physicComponent.physicObject.collisionFilterGroup, physicComponent.physicObject.collisionFilterMask)
    }
