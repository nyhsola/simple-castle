...
import castle.core.common.system.Circle3DRenderSystem
...
class RenderConfig(guiConfig: GUIConfig, commonConfig: CommonConfig) {
    ...
    private val circle3DRenderSystem = Circle3DRenderSystem(guiConfig, commonConfig.cameraService)
    val systems = listOf(modelRenderSystem, line3DRenderSystem, circle3DRenderSystem)
}