...
import castle.core.common.system.BaseCommandsSystem
...
class CommonConfig : Disposable {
    ...
    private val baseControlSystem = BaseCommandsSystem()
    private val animationSystem = AnimationSystem()
    val systems = listOf(baseControlSystem, cameraControlSystem, stageRectRenderSystem, animationSystem)
