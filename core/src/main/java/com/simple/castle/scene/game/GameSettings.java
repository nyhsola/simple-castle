...
public class GameSettings {
    ...
    public static final PlayersJson PLAYERS_JSON = new Json()
            .fromJson(PlayersJson.class, PropertyLoader.loadData("/scenes/game/json/players.json"));
    public static final ObjectConstructorsJson OBJECT_CONSTRUCTORS_JSON = new Json()
            .fromJson(ObjectConstructorsJson.class, PropertyLoader.loadData("/scenes/game/json/object-constructors.json"));
    public static final SceneObjectsJson SCENE_OBJECTS_JSON = new Json()
            .fromJson(SceneObjectsJson.class, PropertyLoader.loadData("/scenes/game/json/scene-objects.json"));
