...
import com.simple.castle.server.game.core.render.AbstractRenderer;
...
public class GameScene extends ScreenAdapter implements InputProcessor, SceneManager {
    ...
    private final AbstractRenderer baseRenderer;
    ...
    public GameScene(AbstractRenderer baseRenderer) {
