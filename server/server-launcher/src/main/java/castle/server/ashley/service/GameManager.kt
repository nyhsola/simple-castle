...
import castle.server.ashley.game.GameEnvironment
import castle.server.ashley.game.Players
...
class GameManager(
    ...
    private fun initializationStep2() {
        ...
        gameContext = GameContext(engine, resourceManager, chat, gameMap, minimap)
